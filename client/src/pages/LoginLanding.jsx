      ...
      <div className="w-full md:w-1/2 flex flex-col items-center justify-center p-6 sm:p-12 lg:p-16 relative overflow-y-auto min-h-screen">
        <div className="w-full max-w-md animate-fade-in relative z-10">
          ...
          <div className="space-y-4">
            {portalOptions.map((portal) => (
              <Link
                ...
                to={portal.to}
              >
                <div className="relative z-10 flex items-center justify-between gap-4 ms:gap-5">
                  <h3 className="text-lg text-slate-800 group-hover:text-indigo-600 md-1 transition-colors">
                    {portal.title}
                  </h3>
          ...
          <div className="mt-12 text-center md:text-left text-sm text-slate-400">
            <p>© {new Date().getFullYear()} mohamed saadat. All rights reserved.</p>
          </div>
        </div>
      </div>
    </div>
